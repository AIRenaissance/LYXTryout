...
export interface ILSP7MintableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeOperator"
      | "authorizedAmountFor"
...
export interface ILSP7Mintable extends BaseContract {
  connect(runner?: ContractRunner | null): ILSP7Mintable;
  waitForDeployment(): Promise<this>;

  interface: ILSP7MintableInterface;
  ...
  mint: TypedContractMethod<
    [to: AddressLike, amount: BigNumberish, force: boolean, data: BytesLike],
    [void],
    "nonpayable"
  >;
