...
import type {
  LSP7Burnable,
  LSP7BurnableInterface,
} from "../../../../../@lukso/lsp7-contracts/contracts/extensions/LSP7Burnable";
...
export class LSP7Burnable__factory {
  static readonly abi = _abi;
  static createInterface(): LSP7BurnableInterface {
    return new Interface(_abi) as LSP7BurnableInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): LSP7Burnable {
    return new Contract(address, _abi, runner) as unknown as LSP7Burnable;
  }
}
