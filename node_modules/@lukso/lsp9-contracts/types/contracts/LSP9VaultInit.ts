...
export interface LSP9VaultInitInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface LSP9VaultInit extends BaseContract {
  connect(runner?: ContractRunner | null): LSP9VaultInit;
  waitForDeployment(): Promise<this>;

  interface: LSP9VaultInitInterface;
  ...
  initialize: TypedContractMethod<[newOwner: AddressLike], [void], "payable">;
