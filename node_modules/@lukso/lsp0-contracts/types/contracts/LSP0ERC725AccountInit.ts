...
export interface LSP0ERC725AccountInitInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface LSP0ERC725AccountInit extends BaseContract {
  connect(runner?: ContractRunner | null): LSP0ERC725AccountInit;
  waitForDeployment(): Promise<this>;

  interface: LSP0ERC725AccountInitInterface;
