...
export interface LSP0ERC725AccountInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface LSP0ERC725Account extends BaseContract {
  connect(runner?: ContractRunner | null): LSP0ERC725Account;
  waitForDeployment(): Promise<this>;

  interface: LSP0ERC725AccountInterface;
