...
export interface LSP11BasicSocialRecoveryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addGuardian"
      | "getGuardianChoice"
...
export interface LSP11BasicSocialRecovery extends BaseContract {
  connect(runner?: ContractRunner | null): LSP11BasicSocialRecovery;
  waitForDeployment(): Promise<this>;

  interface: LSP11BasicSocialRecoveryInterface;
